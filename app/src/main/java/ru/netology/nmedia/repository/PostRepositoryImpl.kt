...
class PostRepositoryImpl : PostRepository {
        ...
        PostsApi.retrofitService.getAllAsync().enqueue(object : Callback<List<Post>> {
            override fun onResponse(call: Call<List<Post>>, response: Response<List<Post>>) {
                ...
                if (response.isSuccessful) {
                    ...
                    callback.onError(RuntimeException("Неудалось загрузить ленту \n error code:${response.code()} "))
                }
            }
    ...
    /*    override fun getAllPost(): Call<List<Post>> {
            return PostsApi.retrofitService.getAllAsync()
        }
    */
        ...
        PostsApi.retrofitService.likeByIdAsync(id).enqueue(object : Callback<Post> {
            override fun onResponse(call: Call<Post>, response: Response<Post>) {
                if (response.isSuccessful) {
                    ...
                    callback.onError(RuntimeException("Неудалось поставить лайк \n error code: ${response.code()}"))
                }
            }
        ...
        PostsApi.retrofitService.unlikeByIdAsync(id).enqueue(object : Callback<Post> {
            override fun onResponse(call: Call<Post>, response: Response<Post>) {
                if (response.isSuccessful) {
                    ...
                    callback.onError(RuntimeException("Неудалось убрать лайк \n error code: ${response.code()}"))
                }
            }
        ...
        PostsApi.retrofitService.removeByIdAsync(id).enqueue(object : Callback<Unit> {
            override fun onResponse(call: Call<Unit>, response: Response<Unit>) {
                if (response.isSuccessful) callback.onSuccess(Unit)
                    ...
                    callback.onError(RuntimeException("Неудалось удалить пост \n error code: ${response.code()}"))
                }
            }
    ...
    override fun saveAsync(post: Post, callback: PostRepository.RepositoryCallback<Unit>) {
        PostsApi.retrofitService.saveAsync(post).enqueue(object : Callback<Unit> {
